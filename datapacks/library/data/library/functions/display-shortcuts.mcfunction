...
execute as @p[tag=L1] at @s run data merge entity @e[tag=L0,tag=g1,limit=1] {CustomNameVisible:1,CustomName:'{"text":"- COLISEUM -","color":"red","bold":true}'}
execute as @p[tag=L2] at @s run data merge entity @e[tag=L0,tag=g1,limit=1] {CustomNameVisible:1,CustomName:'{"text":"- LAB -","color":"aqua","bold":true}'}
execute as @p[tag=L3] at @s run data merge entity @e[tag=L0,tag=g1,limit=1] {CustomNameVisible:1,CustomName:'{"text":"- TRADING AREA -","color":"green","bold":true}'}
execute as @p[tag=L4] at @s run data merge entity @e[tag=L0,tag=g1,limit=1] {CustomNameVisible:1,CustomName:'{"text":"- GALLERY -","color":"yellow","bold":true}'}
execute as @p[tag=L5] at @s run data merge entity @e[tag=L0,tag=g1,limit=1] {CustomNameVisible:1,CustomName:'{"text":"- PARAMETERS -","color":"gray","bold":true}'}
execute as @p[tag=L6] at @s run data merge entity @e[tag=L0,tag=g1,limit=1] {CustomNameVisible:1,CustomName:'{"text":"- MG SCHEDULER -","color":"gold","bold":true}'}
execute as @p[tag=L7] at @s run data merge entity @e[tag=L0,tag=g1,limit=1] {CustomNameVisible:1,CustomName:'{"text":"- ARCHIVES -","color":"light_purple","bold":true}'}
execute as @p[tag=L8] at @s run data merge entity @e[tag=L0,tag=g1,limit=1] {CustomNameVisible:1,CustomName:'{"text":"- MG CREATOR -","color":"dark_aqua","bold":true}'}
