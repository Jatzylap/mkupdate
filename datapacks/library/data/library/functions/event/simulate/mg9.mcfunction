...
execute if score @e[limit=1,name="M@K"] pg1.4 matches 90 run summon armor_stand -356 4 -7 {NoBasePlate:1,Small:1,Invulnerable:1,DisabledSlots:-1,ShowArms:1,Tags:[sml0,"_"]}
...
execute if score @e[limit=1,name="M@K"] pg1.4 matches 70 as @e[tag=sml0,tag=!_] at @s run summon firework_rocket ~ ~ ~ {LifeTime:2,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Flicker:0,Trail:0,Colors:[I;4304440],FadeColors:[I;9843760]}]}}}}
...
execute if score @e[limit=1,name="M@K"] pg1.4 matches 30 as @e[tag=sml0,tag=_] at @s run summon firework_rocket ~ ~ ~ {LifeTime:2,FireworksItem:{id:firework_rocket,Count:1,tag:{Fireworks:{Explosions:[{Type:1,Flicker:0,Trail:0,Colors:[I;4304440],FadeColors:[I;9843760]}]}}}}
