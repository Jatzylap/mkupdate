...
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"aqua","text":"Battle"}'} if entity @s[tag=!0n1] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Branch?"}'} run data merge block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"PvE"}'}
...
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"aqua","text":"Battle"}'} as @s[tag=0n2] at @s if data block -308 15 70 {Text2:'{"bold":true,"color":"green","text":"CLASSIC"}'} run data merge block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"EvE"}'}
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"aqua","text":"Battle"}'} as @s[tag=0n2] at @s if data block -308 15 70 {Text2:'{"bold":true,"color":"light_purple","text":"DEFAULT"}'} run data merge block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"BvB"}'}
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"aqua","text":"Battle"}'} if entity @s[tag=!0n1,tag=!0n2,tag=!0n4] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"EvE"}'} run tag @s add 0n3
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"aqua","text":"Battle"}'} if entity @s[tag=!0n1,tag=!0n2,tag=!0n4] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"BvB"}'} run tag @s add 0n3
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"aqua","text":"Battle"}'} as @s[tag=0n3] at @s run data merge block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"PvE"}'}
