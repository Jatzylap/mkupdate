...
data merge block -308 15 68 {Text3:'{"color":"yellow","clickEvent":{"action":"run_command","value":"/function library:game/toggle/genre"},"text":">>"}'}
...
execute if entity @s[tag=!0n1] if data block -308 15 69 {Text2:'{"bold":true,"color":"aqua","text":"Branch?"}'} run data merge block -308 15 69 {Text2:'{"bold":true,"color":"yellow","text":"Challenge"}'}
