...
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"yellow","text":"Challenge"}'} if entity @s[tag=!0n1] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Genre?"}'} run data merge block -308 15 68 {Text2:'{"bold":true,"color":"yellow","text":"Survival"}'}
...
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"aqua","text":"Battle"}'} if entity @s[tag=!0n1] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Genre?"}'} if data block -308 15 70 {Text2:'{"bold":true,"color":"green","text":"CLASSIC"}'} run data merge block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"BTA"}'}
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"aqua","text":"Battle"}'} if entity @s[tag=!0n1] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Genre?"}'} if data block -308 15 70 {Text2:'{"bold":true,"color":"light_purple","text":"DEFAULT"}'} run data merge block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"PvE"}'}
...
execute if data block -308 15 69 {Text2:'{"bold":true,"color":"light_purple","text":"Party"}'} if entity @s[tag=!0n1] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Genre?"}'} run data merge block -308 15 68 {Text2:'{"bold":true,"color":"light_purple","text":"Skill"}'}
