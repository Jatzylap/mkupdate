...
execute if data block -307 16 72 {Text2:'{"bold":true,"color":"aqua","text":"CUBIC"}'} if score @e[limit=1,name="M@K"] mgc-1 matches 12.. run title @a[tag=ed1t] subtitle ["",{"text":"Height cannot exceed 20 blocks!"}]
...
execute if data block -307 16 72 {Text2:'{"bold":true,"color":"aqua","text":"PRECISE"}'} if score @e[limit=1,name="M@K"] mgc-1 matches 102.. run title @a[tag=ed1t] subtitle ["",{"text":"Height cannot exceed 20.0 blocks!"}]
