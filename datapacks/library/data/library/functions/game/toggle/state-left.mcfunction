...
execute at @s[tag=0n1] run tag @e[name="M@K",limit=1] remove mgc_save
execute at @s[tag=0n1] run data merge block -299 16 72 {Text4:'',Text2:'{"bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/execute unless entity @a[scores={mgc=-1..}] run function library:game/save"},"text":"SAVE"}'}
...
execute at @s[tag=0n2] run data merge block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 1  "},{"color":"aqua","text":"|"}],"text":"|"}'}
...
execute at @s[tag=0n3] run data merge block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 2  "},{"color":"aqua","text":"|"}],"text":"|"}'}
...
execute at @s[tag=0n4] run data merge block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 3  "},{"color":"aqua","text":"|"}],"text":"|"}'}
...
execute at @s[tag=0n5] run data merge block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 4  "},{"color":"aqua","text":"|"}],"text":"|"}'}
...
execute at @s[tag=0n6] run data merge block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 5  "},{"color":"aqua","text":"|"}],"text":"|"}'}
...
execute at @s[tag=0n7] run data merge block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 6  "},{"color":"aqua","text":"|"}],"text":"|"}'}
...
execute at @s[tag=0n8] run data merge block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 7  "},{"color":"aqua","text":"|"}],"text":"|"}'}
...
execute at @s[tag=0n9] run data merge block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 8  "},{"color":"aqua","text":"|"}],"text":"|"}'}
...
execute at @s[tag=0n10] run data merge block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 9  "},{"color":"aqua","text":"|"}],"text":"|"}'}
...
execute at @s[tag=0n11] run data merge block -299 16 72 {Text2:'{"bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/execute unless entity @a[scores={mgc=-1..}] run function library:game/save"},"text":"SAVE AS"}',Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 10  "},{"color":"aqua","text":"|"}],"text":"|"}'}
