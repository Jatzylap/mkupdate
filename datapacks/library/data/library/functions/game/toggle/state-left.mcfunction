...
execute at @s[tag=0n4] run data merge block -299 16 72 {Text2:'{"bold":true,"color":"aqua","clickEvent":{"action":"run_command","value":"/execute unless entity @a[scores={mgc=-1..}] run function library:game/save"},"text":"SAVE AS"}',Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 3  "},{"color":"aqua","text":"|"}],"text":"|"}'}
