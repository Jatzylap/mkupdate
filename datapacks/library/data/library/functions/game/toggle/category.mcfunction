...
data merge block -308 15 69 {Text3:'{"color":"yellow","clickEvent":{"action":"run_command","value":"/function library:game/toggle/branch"},"text":">>"}'}
execute if entity @s[tag=!0n2] if data block -308 15 70 {Text2:'{"bold":true,"color":"green","text":"CLASSIC"}'} run tag @s add 0n1
execute if entity @s[tag=!0n1] if data block -308 15 70 {Text2:'{"bold":true,"color":"aqua","text":"Category?"}'} run data merge block -308 15 70 {Text2:'{"bold":true,"color":"green","text":"CLASSIC"}'}
