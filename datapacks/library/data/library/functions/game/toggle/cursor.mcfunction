...
execute if entity @s[tag=!0n] if data block -307 16 72 {Text2:'{"bold":true,"color":"aqua","text":"PRECISE"}'} run tag @s add 0ff
...
execute as @s[tag=0ff] at @s if score @e[limit=1,name="M@K"] mgc-1 matches 0..10 run scoreboard players set @e[limit=1,name="M@K"] mgc-1 1
