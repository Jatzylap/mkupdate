...
execute as @e[tag=mgc-1r] at @s unless data block -290 15 57 {Text3:'{"color":"red","clickEvent":{"action":"run_command","value":"/function library:game/toggle/trigger"},"extra":[{"color":"yellow","text":" >>"}],"text":"NEVER"}'} run function library:game/loop/ray
