...
execute if entity @e[name="M@K",tag=!mgc_save] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Branch?"}'} run tellraw @s ["",{"text":"[","color":"light_purple","bold":true},{"text":"@","color":"gold","obfuscated":true},{"text":"]","color":"light_purple","bold":true},{"text":" Saving state...","color":"aqua"}]
execute at @s[type=player] if entity @e[tag=mgc_save] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Branch?"}'} if block -299 13 63 red_stained_glass if block -309 11 63 redstone_lamp[lit=false] if blocks -335 2 57 -316 12 69 -299 14 63 masked unless entity @e[tag=3vent,x=-307,y=-10,z=55,dx=16,dy=26,dz=16] run tellraw @s ["",{"text":"This project had no content and was deleted!","color":"red"}]
execute at @s[type=player] if entity @e[tag=mgc_save] if data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Branch?"}'} if data block -299 16 72 {Text4:'{"color":"aqua","extra":[{"color":"green","text":"  Project 1  "},{"color":"aqua","text":"|"}],"text":"|"}'} if block -299 13 63 red_stained_glass if block -309 11 63 redstone_lamp[lit=false] if blocks -335 2 57 -316 12 69 -299 14 63 masked unless entity @e[tag=3vent,x=-307,y=-10,z=55,dx=16,dy=26,dz=16] run tag @e[tag=mgc_save1] remove mgc_save1
...
execute unless data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Branch?"}'} if data block -299 16 72 {Text2:'{"bold":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/execute unless entity @a[scores={mgc=-1..}] run function library:game/save"},"text":"ROUTE"}'} run tellraw @s ["",{"text":"\n[","color":"light_purple","bold":true},{"text":"@","color":"gold","obfuscated":true},{"text":"]","color":"light_purple","bold":true},{"text":" Successfully routed the Game to:\n","color":"green"},{"text":" "},{"text":" Branch: "},{"text":" "},{"text":" "},{"text":" "},{"text":" "},{"text":" "},{"nbt":"Text2","block":"-308 15 68","interpret":true},{"text":"\n "},{"text":" Category: "},{"text":" "},{"text":" "},{"text":" "},{"nbt":"Text2","block":"-308 15 69","interpret":true},{"text":"\n "},{"text":" "},{"text":"Game tower: "},{"text":" "},{"nbt":"Text2","block":"-308 15 70","interpret":true},{"text":" \n","color":"green"}]
execute unless data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Branch?"}'} if data block -299 16 72 {Text2:'{"bold":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/execute unless entity @a[scores={mgc=-1..}] run function library:game/save"},"text":"ROUTE"}'} run tag @e[name="M@K",limit=1] add MGCroute
execute unless data block -308 15 68 {Text2:'{"bold":true,"color":"aqua","text":"Branch?"}'} if data block -299 16 72 {Text2:'{"bold":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/execute unless entity @a[scores={mgc=-1..}] run function library:game/save"},"text":"ROUTE"}'} run data merge block -308 15 68 {Text3:''}
