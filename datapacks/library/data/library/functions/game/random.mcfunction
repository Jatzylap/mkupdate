...
execute unless entity @e[tag=3vent,tag=start] run summon armor_stand -299 0 63 {Tags:[3vent,start,mgc_rand0m],Marker:1,Invisible:1,Passengers:[{id:magma_cube,DeathLootTable:"",PersistenceRequired:1,Invulnerable:1,NoAI:1,Tags:[3vent,gl0w,mgc-start],Team:mgc-start}]}
execute unless entity @e[tag=3vent,tag=end] run summon armor_stand -299 0 63 {Tags:[3vent,end,focus,mgc_rand0m],Marker:1,Invisible:1,Passengers:[{id:magma_cube,DeathLootTable:"",PersistenceRequired:1,Invulnerable:1,NoAI:1,Tags:[3vent,gl0w,mgc-end],Team:mgc-end}]}
...
execute if data block -304 5 45 Items[{Slot:0b,Count:4b,id:"minecraft:stick"}] run data merge block -290 16 60 {Text2:'{"bold":true,"color":"green","text":"Disc.pigstep"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:4b,id:"minecraft:stick"}] run data merge block -290 16 60 {Text2:'{"bold":true,"color":"green","text":"Disc.chirp"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:4b,id:"minecraft:stick"}] run data merge block -290 16 60 {Text2:'{"bold":true,"color":"green","text":"Disc.strad"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:4b,id:"minecraft:stick"}] run data merge block -290 16 60 {Text2:'{"bold":true,"color":"green","text":"Disc.stal"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:4b,id:"minecraft:stick"}] run data merge block -290 16 60 {Text2:'{"bold":true,"color":"green","text":"Disc.wait"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:4b,id:"minecraft:stick"}] run data merge block -290 16 60 {Text2:'{"bold":true,"color":"gray","text":"Silent"}'}
...
execute if data block -304 5 45 Items[{Slot:0b,Count:5b,id:"minecraft:stick"}] run data merge block -290 15 58 {Text3:'{"bold":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/function library:game/toggle/button"},"text":"Interaction","extra":[{"bold":false,"color":"yellow","text":" >>"}]}',Text2:'{"bold":true,"color":"white","text":"TERMINATES"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:6b,id:"minecraft:stick"}] run data merge block -290 15 58 {Text3:'{"bold":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/function library:game/toggle/button"},"extra":[{"bold":false,"color":"light_purple","text":"@End"},{"bold":false,"color":"yellow","text":" >>"}],"text":"with "}',Text2:'{"bold":true,"color":"white","text":"TERMINATES"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:7b,id:"minecraft:stick"}] run data merge block -290 15 58 {Text3:'{"bold":true,"color":"red","clickEvent":{"action":"run_command","value":"/function library:game/toggle/button"},"extra":[{"bold":false,"color":"yellow","text":" >>"}],"text":"Nothing"}',Text2:'{"bold":true,"color":"white","text":"TERMINATES"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:8b,id:"minecraft:stick"}] run data merge block -290 15 58 {Text3:'{"bold":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/function library:game/toggle/button"},"text":"Interaction","extra":[{"bold":false,"color":"yellow","text":" >>"}]}',Text2:'{"bold":true,"color":"white","text":"TERMINATES"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:9b,id:"minecraft:stick"}] run data merge block -290 15 58 {Text3:'{"bold":true,"color":"red","clickEvent":{"action":"run_command","value":"/function library:game/toggle/button"},"extra":[{"bold":false,"color":"yellow","text":" >>"}],"text":"Nothing"}',Text2:'{"bold":true,"color":"white","text":"TERMINATES"}'}
execute if data block -304 5 45 Items[{Slot:0b,Count:10b,id:"minecraft:stick"}] run data merge block -290 15 58 {Text3:'{"bold":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/function library:game/toggle/button"},"text":"Interaction","extra":[{"bold":false,"color":"yellow","text":" >>"}]}',Text2:'{"bold":true,"color":"white","text":"TERMINATES"}'}
...
execute if data block -304 5 45 Items[{Slot:0b,Count:5b,id:"minecraft:stick"}] if entity @e[tag=mgc_p] run data merge block -306 15 54 {Text2:'{"bold":true,"color":"white","text":"Criterion:"}',Text3:'{"bold":true,"color":"yellow","clickEvent":{"action":"run_command","value":"/function library:game/toggle/criterion"},"text":"Break Block"}',Text4:'{"color":"yellow","text":"<<"}'}
...
execute as @e[tag=3vent,tag=start] at @s run fill ~ 0 ~ ~ 11 ~ air replace barrier
execute as @e[tag=3vent,tag=start] at @s if blocks ~ ~-1 ~ ~ 1 ~ -299 14 63 masked run fill ~-1 1 ~-1 ~1 1 ~1 grass_block keep
