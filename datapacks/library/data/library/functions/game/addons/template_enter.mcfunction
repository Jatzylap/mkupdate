...
#> Use the '#' at the beginning of a command to cancel it
...
#------------------------------EXAMPLES--------------------------------#
#> These commands shall execute ONLY ONCE upon game entry!
#> PS: (you can write as many commands as you want below!)

#tellraw @a[scores={mgc=-1}] ["",{"text":"Access granted","color":"white"}]
execute positioned ~ ~-3 ~ run playsound block.note_block.hat master @a[scores={mgc=-1}] ~ ~ ~ 1