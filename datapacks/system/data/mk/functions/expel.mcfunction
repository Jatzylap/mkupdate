...
execute unless entity @s[tag=L_chabadu] run effect give @a[tag=3xp,tag=!3xp0] blindness 4 99 true
...
execute at @s[tag=L_chabadu,tag=s] unless entity @r[tag=3xp,distance=..2,dy=2] run tp @s ^ ^ ^1 facing entity @r[tag=3xp]
tp @s[tag=L_chabadu,tag=s] ~ 2 ~
