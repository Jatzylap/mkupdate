...
execute as @e[tag=n,scores={0=1625..1648}] at @s unless entity @e[tag=1p] unless entity @e[tag=3p] run title @a[team=!,tag=!] title [""]
execute as @e[tag=n,scores={0=1628}] at @s unless entity @e[tag=1p] unless entity @e[tag=3p] run title @a[team=!,tag=!] subtitle ["",{"text":"~ ","bold":true},{"text":"S","color":"yellow","bold":true},{"text":"pawn ~","bold":true}]
execute as @e[tag=n,scores={0=1632}] at @s unless entity @e[tag=1p] unless entity @e[tag=3p] run title @a[team=!,tag=!] subtitle ["",{"text":"~ ","bold":true},{"text":"S","color":"gold","bold":true},{"text":"p","color":"yellow","bold":true},{"text":"awn ~","bold":true}]
execute as @e[tag=n,scores={0=1636}] at @s unless entity @e[tag=1p] unless entity @e[tag=3p] run title @a[team=!,tag=!] subtitle ["",{"text":"~ ","bold":true},{"text":"Sp","color":"gold","bold":true},{"text":"a","color":"yellow","bold":true},{"text":"wn ~","bold":true}]
execute as @e[tag=n,scores={0=1640}] at @s unless entity @e[tag=1p] unless entity @e[tag=3p] run title @a[team=!,tag=!] subtitle ["",{"text":"~ ","bold":true},{"text":"Spa","color":"gold","bold":true},{"text":"w","color":"yellow","bold":true},{"text":"n ~","bold":true}]
execute as @e[tag=n,scores={0=1644}] at @s unless entity @e[tag=1p] unless entity @e[tag=3p] run title @a[team=!,tag=!] subtitle ["",{"text":"~ ","bold":true},{"text":"Spaw","color":"gold","bold":true},{"text":"n","color":"yellow","bold":true},{"text":" ~","bold":true}]
execute as @e[tag=n,scores={0=1648}] at @s unless entity @e[tag=1p] unless entity @e[tag=3p] run title @a[team=!,tag=!] subtitle ["",{"text":"~ ","bold":true},{"text":"Spawn","color":"gold","bold":true},{"text":" ~","bold":true}]
...
execute if entity @e[name="M@K",tag=mode2] as @e[tag=n,scores={0=..50}] at @s run scoreboard players set @s 0 1875