...
advancement grant @s only mk:tutorial
...
execute if entity @e[tag=3p] run advancement grant @s only mk:unlock_all
execute if block -32 9 -8 air run advancement grant @s only mk:discover_tower
execute if block -194 6 -8 air run advancement grant @s only mk:discover_library
