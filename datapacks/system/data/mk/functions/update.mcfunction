...
execute if block -113 9 9 beacon{Levels:0} run tellraw @s ["",{"text":"\nM","color":"green","bold":true},{"text":"K","color":"aqua","bold":true},{"text":">","color":"light_purple"},{"text":" No info available for the present time... try reloading the world.","color":"red"}]
