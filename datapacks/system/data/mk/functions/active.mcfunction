...
execute as @e[type=bat,tag=pos] at @s if entity @e[type=bat,tag=pos,dx=0,dy=0,dz=0,distance=0.1..0.2] run kill @e[type=bat,tag=pos2,distance=..2]
execute as @e[type=bat,tag=pos] at @s if entity @s[dx=0,dy=0,dz=0] run kill @s
...
execute as @a at @s unless entity @a[tag=00p] unless entity @s[x=-67,y=5,z=76,distance=..10] unless entity @s[x=-88,y=5,z=87,distance=..10] unless entity @s[x=-31,y=5,z=-46,distance=..10] unless data entity @s EnderItems[{Slot:13b}] run function mk:exit
execute as @a at @s unless entity @a[tag=00p] if entity @s[x=-67,y=5,z=76,distance=..10] unless data entity @s EnderItems[{Slot:13b}] run function c1:leave
execute as @a at @s unless entity @a[tag=00p] if entity @s[x=-88,y=5,z=87,distance=..10] unless data entity @s EnderItems[{Slot:13b}] run function c2:leave
execute as @a at @s unless entity @a[tag=00p] if entity @s[x=-31,y=5,z=-46,distance=..10] unless data entity @s EnderItems[{Slot:13b}] run function c3:leave
...
execute as @e[tag=p0ly,tag=!0,tag=!b0ss] at @s if entity @e[tag=3p,tag=02p] run particle block dirt ~ ~ ~ 1 1 1 0 10 normal @a[tag=!N0]
...
execute if entity @e[tag=1p] as @e[tag=p0ly,tag=0] at @s run tp @s ~ ~ ~ facing entity @p
...
#SPAWN
execute as @a[tag=!1,x=-113,y=12,z=-8,dy=20] at @s if block ~ ~-0.5 ~ air run scoreboard players reset @s 0
execute as @a[tag=1,tag=00p] at @s unless score @s 6 matches 0.. run scoreboard players set @s 6 0
execute as @e[type=!armor_stand,x=-113,y=12,z=-8,dy=20] at @s if block ~ ~-0.5 ~ air run tag @s add 1
...
execute as @a[tag=1,scores={0=1}] at @s run function clear:chat
...
execute unless entity @a[tag=00p] if entity @e[name="M@K",limit=1,tag=!0p,tag=!00p,tag=!01p,tag=!1p,tag=!2p] run title @a[tag=1] actionbar ["",{"text":"[","color":"light_purple","bold":true},{"text":"@","color":"gold","obfuscated":true},{"text":"]","color":"light_purple","bold":true},{"text":" Loading Minigames...","color":"green","bold":true}]
...
execute unless entity @a[tag=1,x=-113,y=12,z=-8,dy=20] run kill @e[type=armor_stand,tag=r]
execute as @a[tag=1,tag=P0ft] at @s positioned ~ ~-0.3 ~ run particle firework ~ ~ ~ 0.1 0.1 0.1 0.1 1 force @a[tag=P0ft,tag=!N0]
execute as @e[type=armor_stand,tag=r] at @s positioned ^ ^-1 ^0.5 run particle totem_of_undying ~ ~ ~ 0.1 0.1 0.1 0 5 normal @a[tag=!N0]
execute as @a[tag=1] at @s unless entity @e[type=armor_stand,tag=r] if entity @s[x=-113,y=12,z=-8,dy=20] run summon armor_stand ~ ~ ~ {Marker:1,Invisible:1b,NoGravity:1b,Tags:[r]}
execute as @a[tag=1] at @s run tp @e[type=armor_stand,tag=r] ~ ~ ~
execute as @e[type=armor_stand,tag=r] at @s run tp @s ~ ~ ~ ~15 ~
execute as @a[tag=1,x=-113,y=12,z=-8,dy=20] at @s unless block ~ ~-1 ~ air run particle firework ~ ~ ~ 0 1.5 0 0.1 100 normal @a
execute as @a[tag=1] at @s unless block ~ ~-1 ~ air run effect give @s speed 10 2 true
execute as @a[tag=1,x=-113,y=12,z=-8,dy=20] at @s unless block ~ ~-1 ~ air run effect give @s speed 10 3 true
...
execute as @a at @s if score @s 1 matches 5..100 run particle cloud -113 8.5 24 0.3 0.3 0.3 0 30 normal @a[tag=!N0]
execute as @a[tag=2] at @s if score @s 1 matches 5 run fill -112 9 24 -114 10 24 air replace #fences
execute as @a[tag=2] at @s if score @s 1 matches 5 run setblock -111 10 24 spruce_fence
execute as @a[tag=2] at @s if score @s 1 matches 5 run setblock -115 10 24 spruce_fence
execute as @a[tag=2] at @s if score @s 1 matches 5 run clone -113 17 24 -113 8 24 -113 7 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 10 run clone -113 16 24 -113 7 24 -113 6 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 20 run clone -113 15 24 -113 6 24 -113 5 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 30 run clone -113 14 24 -113 5 24 -113 4 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 40 run clone -113 13 24 -113 4 24 -113 3 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 50 run clone -113 12 24 -113 3 24 -113 2 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 60 run clone -113 11 24 -113 2 24 -113 1 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 70 run clone -113 10 24 -113 1 24 -113 0 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 80 run clone -113 9 24 -113 1 24 -113 0 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 90 run clone -113 8 24 -113 1 24 -113 0 24 replace move
execute as @a[tag=2] at @s if score @s 1 matches 100 run fill -112 10 25 -114 11 25 air destroy
execute as @a[tag=2] at @s if score @s 1 matches 100 run setblock -113 9 25 air destroy
execute as @a[tag=2] at @s if score @s 1 matches 100 run setblock -113 16 24 stone_bricks

execute as @a[tag=!2,scores={1=1..}] at @s run scoreboard players remove @s 1 1
execute as @a[tag=!2] at @s if score @s 1 matches 100 run setblock -113 16 24 air
execute as @a[tag=!2] at @s if score @s 1 matches 100 run clone -113 8 24 -113 0 24 -113 1 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 95 run clone -113 9 24 -113 1 24 -113 2 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 90 run clone -113 10 24 -113 2 24 -113 3 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 85 run clone -113 11 24 -113 3 24 -113 4 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 80 run clone -113 12 24 -113 4 24 -113 5 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 75 run clone -113 13 24 -113 5 24 -113 6 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 70 run clone -113 14 24 -113 6 24 -113 7 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 65 run fill -112 9 24 -114 10 24 spruce_fence replace air
execute as @a[tag=!2] at @s if score @s 1 matches 60 run clone -113 15 24 -113 7 24 -113 8 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 55 run clone -113 16 24 -113 8 24 -113 9 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 50 run clone -113 17 24 -113 9 24 -113 10 24 replace move
execute as @a[tag=!2] at @s if score @s 1 matches 45 run fill -114 11 25 -112 11 25 spruce_planks
execute as @a[tag=!2] at @s if score @s 1 matches 40 run fill -114 10 25 -112 10 25 stone_bricks
execute as @a[tag=!2] at @s if score @s 1 matches 35 run fill -113 16 24 -113 13 24 oak_log
execute as @a[tag=!2] at @s if score @s 1 matches 30 run setblock -113 12 24 glowstone
execute as @a[tag=!2] at @s if score @s 1 matches 25 run fill -113 11 24 -113 8 24 oak_log
execute as @a[tag=!2] at @s if score @s 1 matches 20 run fill -112 15 24 -114 19 24 air replace water
execute as @a[tag=!2] at @s if score @s 1 matches 15 run setblock -113 17 24 stone_brick_wall
execute as @a[tag=!2] at @s if score @s 1 matches 10 run setblock -111 10 24 air
execute as @a[tag=!2] at @s if score @s 1 matches 5 run setblock -115 10 24 air
execute as @a[tag=!2] at @s if score @s 1 matches 5 run setblock -113 9 25 stone_bricks
execute as @a[tag=!2] at @s if score @s 1 matches 5 run fill -112 9 24 -114 10 24 spruce_fence replace water
execute as @a[tag=!2] at @s if score @s 1 matches 5 run setblock -114 10 24 spruce_fence[east=true]
execute as @a[tag=!2] at @s if score @s 1 matches 5 run setblock -112 10 24 spruce_fence[west=true]
...
#LIBRARY
execute as @p[team=!,x=-184,y=3,z=-8,distance=..5] at @s if entity @e[tag=0p,tag=!2p] run fill -194 6 -7 -194 7 -9 air destroy
execute as @p[team=!,x=-184,y=3,z=-8,distance=..5] at @s if entity @e[tag=0p,tag=!2p] if block -193 9 -8 stone_brick_stairs run summon falling_block -193 9 -8 {Time:1,BlockState:{Name:"stone_brick_stairs",Properties:{facing:west}}}
execute as @p[team=!,x=-184,y=3,z=-8,distance=..5] at @s if entity @e[tag=0p,tag=!2p] run advancement grant @a only mk:discover_library
...
execute if entity @p[x=-184,y=3,z=-8,distance=..5] run tag @e[tag=0p] add 2p
...
execute at @e[tag=n,scores={0=50..}] if entity @e[tag=02p,tag=!5p] run function mk:talk/3
...
#Xopoly
kill @e[type=area_effect_cloud,x=-346,y=228,z=85,dx=26,dy=32,dz=26]
...
execute if score @e[limit=1,name="M@K",tag=!mg-1,tag=!mg-1s] 6 matches 856 run playsound music_disc.pigstep master @a[tag=mg-1] -333 231 98 100000 1.9
execute if score @e[limit=1,name="M@K",tag=mg-1] 6 matches 1 run stopsound @a[tag=mg-1] master music_disc.pigstep
execute if score @e[limit=1,name="M@K",tag=mg-1] 6 matches 1 run playsound music_disc.pigstep master @a[tag=mg-1] -333 231 98 100000 1.9
execute if score @e[limit=1,name="M@K",tag=mg-1s] 6 matches 1 run playsound music_disc.pigstep master @a[tag=mg-1] -333 231 98 100000 1.9
...
execute if entity @e[limit=1,name="M@K",scores={6=1420..}] run stopsound @a[tag=XPplayers] master music_disc.pigtep
...
execute as @e[tag=b0ss,tag=p0ly] at @s if entity @e[limit=1,name="M@K",tag=mg-1] unless block ~ ~-0.5 ~ air run particle block dirt ~ ~ ~ 0.2 1 0.2 0 10 normal @a[tag=!N0]
...
execute as @r[team=!,tag=XPwinner] at @s run stopsound @s master music_disc.pigstep
...
execute as @a[scores={lobby=1..},tag=!3dit] at @s if data entity @s EnderItems[{Slot:13b,id:"minecraft:knowledge_book"}] run tag @s remove T0
execute as @a[scores={lobby=1..},tag=!3dit] at @s if data entity @s EnderItems[{Slot:13b,id:"minecraft:knowledge_book"}] run advancement grant @s only mk:use_trigger
execute as @a[scores={lobby=1..},tag=!3dit] at @s if data entity @s EnderItems[{Slot:13b,id:"minecraft:knowledge_book"}] run advancement grant @s only mk:extra
execute as @a[scores={2=1..}] at @s in overworld unless entity @s[tag=!m-g,team=] run tp @s -113 32 -8
execute as @a[scores={2=1..}] at @s in overworld unless entity @s[tag=!m-g,team=] run tag @s remove 10bby

execute as @a[scores={2=1..},tag=st0red] at @s run tellraw @s ["",{"text":"\n[","color":"yellow","bold":true},{"text":"@","color":"aqua","obfuscated":true},{"text":"]","color":"yellow","bold":true},{"text":" You weren't reset from the previous game...","color":"red"},{"text":" \n[Click here to Rollback/Reset]\n","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/trigger interact"}}]
...
execute as @a[scores={lobby=1..},tag=st0red,tag=!3dit] at @s unless score @s 2 matches 1.. unless score @s mgc matches -1.. if entity @s[tag=!draw0l,tag=!draw0d,tag=!draw0c] run tellraw @s ["",{"text":"\n[","color":"yellow","bold":true},{"text":"@","color":"aqua","obfuscated":true},{"text":"]","color":"yellow","bold":true},{"text":" You weren't reset from the previous game...","color":"red"},{"text":" \n[Click here to Rollback/Reset]\n","color":"yellow","bold":true,"clickEvent":{"action":"run_command","value":"/trigger interact"}}]
execute as @a[scores={lobby=1..},tag=st0red] at @s unless score @s 2 matches 1.. unless score @s mgc matches -1.. if entity @s[tag=!draw0l,tag=!draw0d,tag=!draw0c] run scoreboard players enable @s interact
execute as @a[scores={lobby=1..},tag=st0red] at @s unless score @s 2 matches 1.. unless score @s mgc matches -1.. if entity @s[tag=!draw0l,tag=!draw0d,tag=!draw0c] run tag @s add mk.03
execute as @a[tag=mk.03,scores={interact=1..}] at @s run function mk:rejoin
...
execute as @a[scores={mgc=0..,lobby=1..},tag=m-g] at @s run clear @s
...
execute as @a[team=Admin,tag=Member] at @s if entity @s[scores={rank=0}] run title @s actionbar ["",{"text":"You are recognised as a Member! Use "},{"text":"/trigger rank","color":"yellow"},{"text":" to update"}]
...
execute as @e[tag=C0,x=-29,y=9,z=-8,tag=!t,dy=3] at @s run tag @s add s
...
execute as @e[tag=!u,tag=C0] at @s unless entity @p[distance=..3] run data merge entity @s {CustomName:'',CustomNameVisible:0}
...
execute as @e[tag=D0,x=-113,y=9,z=-92,tag=!t,dy=3] at @s run tag @s add s
...
execute as @r[tag=st0red,tag=!_rel_] at @s run tag @s add st0re
execute as @e[tag=st0rage] at @s if score @r[tag=st0re] 5 = @s 5 run tp @s @r[tag=st0re]
tag @a remove st0re
...
execute if score @e[limit=1,name="M@K"] m matches ..1 unless entity @a[tag=00p] as @a[tag=Member] at @s run item replace entity @s enderchest.13 with knowledge_book{Enchantments:[{id:12,lvl:1}],gui:1,display:{Name:'{"text":" [STORY MODE]","color":"gold","bold":true,"italic":false}',Lore:['{"text":">> Click to return to parent Lobby <<","color":"gray","italic":false}']}}
execute if score @e[limit=1,name="M@K"] m matches 1.. unless entity @a[tag=00p] as @a[tag=Member] at @s run item replace entity @s enderchest.13 with knowledge_book{Enchantments:[{id:12,lvl:1}],gui:1,display:{Name:'{"text":" [RANK]","color":"green","italic":false}',Lore:['{"text":" MEMBER","color":"gold","bold":true,"italic":false}','{"text":">> Click to return to parent Lobby <<","color":"gray","italic":false}']}}
execute if score @e[limit=1,name="M@K"] m matches 1.. unless entity @a[tag=00p] as @a[tag=Admin] at @s run item replace entity @s enderchest.13 with knowledge_book{Enchantments:[{id:12,lvl:1}],gui:1,display:{Name:'{"text":" [RANK]","color":"green","italic":false}',Lore:['{"text":" ADMIN","color":"dark_aqua","bold":true,"italic":false}','{"text":">> Click to return to parent Lobby <<","color":"gray","italic":false}']}}
...
execute as @a[team=!,tag=!m-g,tag=!10bby,tag=!mg-1] at @s if entity @e[name="M@K"] unless entity @s[x=-239,y=3,z=65,distance=..16] run function mk:reset/coliseum
...
execute as @e[type=firework_rocket,limit=1,tag=g1.1] at @s run summon experience_orb ~ ~ ~ {Motion:[0.0d,0.4d,0.5d],Value:9s}
...
execute as @a[tag=!m-g,tag=mg0-1] at @s unless score @s mg15 matches 1.. in parallel_overworld run forceload add 0 0
execute as @a[tag=!m-g,tag=mg0-1] at @s unless score @s mg15 matches 1.. in parallel_overworld run setblock 0 0 0 shulker_box
execute as @a[tag=!m-g,tag=mg0-1] at @s unless score @s mg15 matches 1.. in parallel_overworld run setblock 0 1 0 bedrock
execute as @a[tag=!m-g,tag=mg0-1] at @s unless score @s mg15 matches 1.. in parallel_overworld run spreadplayers 0 0 0 999 false @s
execute as @a[tag=!m-g,tag=mg0-2] at @s unless score @s mg15 matches 1.. in parallel_nether run forceload add 0 0
execute as @a[tag=!m-g,tag=mg0-2] at @s unless score @s mg15 matches 1.. in parallel_nether run setblock 0 0 0 shulker_box
execute as @a[tag=!m-g,tag=mg0-2] at @s unless score @s mg15 matches 1.. in parallel_nether run setblock 0 1 0 bedrock
...
execute as @a[tag=!m-g,tag=mg0-3] at @s unless score @s mg15 matches 1.. in the_end run forceload add 0 0
execute as @a[tag=!m-g,tag=mg0-3] at @s unless score @s mg15 matches 1.. in the_end run setblock 0 254 0 shulker_box
execute as @a[tag=!m-g,tag=mg0-3] at @s unless score @s mg15 matches 1.. in the_end run fill -1 253 -1 1 255 1 bedrock keep
...
execute as @e[tag=L_chabadu,tag=s,scores={6=269}] at @s run data merge entity @s {AttachFace:1,Rotation:[90f],Peek:100}
execute as @e[tag=L_chabadu,tag=s,scores={6=280..360}] at @s unless entity @a[tag=3xp] if entity @a[x=-307,y=1,z=1,dz=2,dx=15,dy=2] run playsound entity.shulker.ambient master @a ~ ~ ~ 0.6 1.8
execute as @e[tag=L_chabadu,tag=s,scores={6=280..360}] at @s unless entity @a[tag=3xp] if entity @a[x=-307,y=1,z=1,dz=2,dx=15,dy=2] run schedule function mk:expel 1.5s
execute as @e[tag=L_chabadu,tag=s,scores={6=280..360}] at @s unless entity @a[tag=3xp] if entity @a[x=-307,y=1,z=1,dz=2,dx=15,dy=2] run tag @a[x=-307,y=1,z=1,dz=2,dx=14,dy=2] add 3xp
execute as @e[tag=L_chabadu,tag=s,scores={6=280..360}] at @s if entity @a[tag=3xp] run function mk:expel
execute as @e[tag=L_chabadu,tag=s,scores={6=275}] at @s run data merge entity @s {Rotation:[-90f]}
execute as @e[tag=L_chabadu,tag=s,scores={6=305}] at @s run data merge entity @s {Rotation:[90f]}
execute as @e[tag=L_chabadu,tag=s,scores={6=360}] at @s run data merge entity @s {Peek:0}
...
execute as @a[tag=draw0c] at @s unless entity @e[tag=st0rage,distance=..1] if block ~ ~-1 ~ barrier run function get:panel_tools
execute as @a[tag=draw0d] at @s unless entity @e[tag=st0rage,distance=..1] if block ~ ~-1 ~ barrier run function get:panel_tools
execute as @a[tag=draw0l] at @s unless entity @e[tag=st0rage,distance=..1] if block ~ ~-1 ~ barrier run function get:panel_tools
...
execute if entity @a[advancements={mk:tutorial=true}] run scoreboard players add @a[scores={6=0..}] 6 1
...
execute as @e[type=shulker,tag=p0ly] at @s unless entity @a[team=!,distance=..7] run data merge entity @s {Peek:0}
...
execute as @a[tag=L1] at @s align xz if entity @e[tag=L0,tag=g1,dy=1,name="- COLISEUM -"] run tp -233 9 10
execute as @a[tag=L2] at @s align xz if entity @e[tag=L0,tag=g1,dy=1,name="- LAB -"] run tp -209 19 -92
execute as @a[tag=L3] at @s align xz if entity @e[tag=L0,tag=g1,dy=1,name="- TRADING AREA -"] run tp -234 14 -103
execute as @a[tag=L4] at @s align xz if entity @e[tag=L0,tag=g1,dy=1,name="- GALLERY -"] run tp -246 9 -27
execute as @a[tag=L5] at @s align xz if entity @e[tag=L0,tag=g1,dy=1,name="- PARAMETERS -"] run tp -151 35 -61
execute as @a[tag=L6] at @s align xz if entity @e[tag=L0,tag=g1,dy=1,name="- MG SCHEDULER -"] run tp -326 3 -8
execute as @a[tag=L7] at @s align xz if entity @e[tag=L0,tag=g1,dy=1,name="- ARCHIVES -"] run tp -316 1 7
execute as @a[tag=L8] at @s align xz if entity @e[tag=L0,tag=g1,dy=1,name="- MG CREATOR -"] run tp -299 4 41
execute as @a[tag=L1] at @s align xz if entity @e[tag=L0,tag=g2,dy=1,name="- COLISEUM -"] run tp -233 9 10
execute as @a[tag=L2] at @s align xz if entity @e[tag=L0,tag=g2,dy=1,name="- LAB -"] run tp -209 19 -92
execute as @a[tag=L3] at @s align xz if entity @e[tag=L0,tag=g2,dy=1,name="- TRADING AREA -"] run tp -234 14 -103
execute as @a[tag=L4] at @s align xz if entity @e[tag=L0,tag=g2,dy=1,name="- GALLERY -"] run tp -246 9 -27
execute as @a[tag=L5] at @s align xz if entity @e[tag=L0,tag=g2,dy=1,name="- PARAMETERS -"] run tp -151 35 -61
execute as @a[tag=L6] at @s align xz if entity @e[tag=L0,tag=g2,dy=1,name="- MG SCHEDULER -"] run tp -326 3 -8
execute as @a[tag=L7] at @s align xz if entity @e[tag=L0,tag=g2,dy=1,name="- ARCHIVES -"] run tp -316 1 7
execute as @a[tag=L8] at @s align xz if entity @e[tag=L0,tag=g2,dy=1,name="- MG CREATOR -"] run tp -299 4 41
execute as @a[tag=L1] at @s align xz if entity @e[tag=L0,tag=g3,dy=1,name="- COLISEUM -"] run tp -233 9 10
execute as @a[tag=L2] at @s align xz if entity @e[tag=L0,tag=g3,dy=1,name="- LAB -"] run tp -209 19 -92
execute as @a[tag=L3] at @s align xz if entity @e[tag=L0,tag=g3,dy=1,name="- TRADING AREA -"] run tp -234 14 -103
execute as @a[tag=L4] at @s align xz if entity @e[tag=L0,tag=g3,dy=1,name="- GALLERY -"] run tp -246 9 -27
execute as @a[tag=L5] at @s align xz if entity @e[tag=L0,tag=g3,dy=1,name="- PARAMETERS -"] run tp -151 35 -61
execute as @a[tag=L6] at @s align xz if entity @e[tag=L0,tag=g3,dy=1,name="- MG SCHEDULER -"] run tp -326 3 -8
execute as @a[tag=L7] at @s align xz if entity @e[tag=L0,tag=g3,dy=1,name="- ARCHIVES -"] run tp -316 1 7
execute as @a[tag=L8] at @s align xz if entity @e[tag=L0,tag=g3,dy=1,name="- MG CREATOR -"] run tp -299 4 41
execute as @a[tag=L1] at @s align xz if entity @e[tag=L0,tag=g4,dy=1,name="- COLISEUM -"] run tp -233 9 10
execute as @a[tag=L2] at @s align xz if entity @e[tag=L0,tag=g4,dy=1,name="- LAB -"] run tp -209 19 -92
execute as @a[tag=L3] at @s align xz if entity @e[tag=L0,tag=g4,dy=1,name="- TRADING AREA -"] run tp -234 14 -103
execute as @a[tag=L4] at @s align xz if entity @e[tag=L0,tag=g4,dy=1,name="- GALLERY -"] run tp -246 9 -27
execute as @a[tag=L5] at @s align xz if entity @e[tag=L0,tag=g4,dy=1,name="- PARAMETERS -"] run tp -151 35 -61
execute as @a[tag=L6] at @s align xz if entity @e[tag=L0,tag=g4,dy=1,name="- MG SCHEDULER -"] run tp -326 3 -8
execute as @a[tag=L7] at @s align xz if entity @e[tag=L0,tag=g4,dy=1,name="- ARCHIVES -"] run tp -316 1 7
execute as @a[tag=L8] at @s align xz if entity @e[tag=L0,tag=g4,dy=1,name="- MG CREATOR -"] run tp -299 4 41
execute as @a[tag=L1] at @s align xz if entity @e[tag=L0,tag=g5,dy=1,name="- COLISEUM -"] run tp -233 9 10
execute as @a[tag=L2] at @s align xz if entity @e[tag=L0,tag=g5,dy=1,name="- LAB -"] run tp -209 19 -92
execute as @a[tag=L3] at @s align xz if entity @e[tag=L0,tag=g5,dy=1,name="- TRADING AREA -"] run tp -234 14 -103
execute as @a[tag=L4] at @s align xz if entity @e[tag=L0,tag=g5,dy=1,name="- GALLERY -"] run tp -246 9 -27
execute as @a[tag=L5] at @s align xz if entity @e[tag=L0,tag=g5,dy=1,name="- PARAMETERS -"] run tp -151 35 -61
execute as @a[tag=L6] at @s align xz if entity @e[tag=L0,tag=g5,dy=1,name="- MG SCHEDULER -"] run tp -326 3 -8
execute as @a[tag=L7] at @s align xz if entity @e[tag=L0,tag=g5,dy=1,name="- ARCHIVES -"] run tp -316 1 7
execute as @a[tag=L8] at @s align xz if entity @e[tag=L0,tag=g5,dy=1,name="- MG CREATOR -"] run tp -299 4 41
execute as @a[tag=L1] at @s align xz if entity @e[tag=L0,tag=g6,dy=1,name="- COLISEUM -"] run tp -233 9 10
execute as @a[tag=L2] at @s align xz if entity @e[tag=L0,tag=g6,dy=1,name="- LAB -"] run tp -209 19 -92
execute as @a[tag=L3] at @s align xz if entity @e[tag=L0,tag=g6,dy=1,name="- TRADING AREA -"] run tp -234 14 -103
execute as @a[tag=L4] at @s align xz if entity @e[tag=L0,tag=g6,dy=1,name="- GALLERY -"] run tp -246 9 -27
execute as @a[tag=L5] at @s align xz if entity @e[tag=L0,tag=g6,dy=1,name="- PARAMETERS -"] run tp -151 35 -61
execute as @a[tag=L6] at @s align xz if entity @e[tag=L0,tag=g6,dy=1,name="- MG SCHEDULER -"] run tp -326 3 -8
execute as @a[tag=L7] at @s align xz if entity @e[tag=L0,tag=g6,dy=1,name="- ARCHIVES -"] run tp -316 1 7
execute as @a[tag=L8] at @s align xz if entity @e[tag=L0,tag=g6,dy=1,name="- MG CREATOR -"] run tp -299 4 41