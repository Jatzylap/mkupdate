...
execute as @a[tag=1,x=-113,y=12,z=-8,dy=50] at @s unless block ~ ~-1 ~ air run particle firework ~ ~ ~ 0 1.5 0 0.1 100 normal @a
...
execute as @a[tag=!mg0,tag=!mg0+1,tag=!mg0-1,tag=!mg0-2,tag=!mg0-3,nbt=!{Dimension:"minecraft:void"},nbt=!{Dimension:"minecraft:parallel_overworld"},nbt=!{Dimension:"minecraft:parallel_nether"},nbt=!{Dimension:"minecraft:the_end"}] at @s anchored eyes unless score @s mgc matches -1.. run execute as @e[type=item,tag=,nbt={Age:0s},distance=..150000] at @s unless score @p drop matches 1.. unless entity @s[x=-254,y=17,z=-123,distance=..13] unless entity @s[x=-295,y=13,z=54,dx=6,dy=3] unless entity @s[x=-187,y=2,z=-153,distance=..9] unless entity @s[x=-203,y=2,z=-149,distance=..9] unless entity @s[x=-192,y=2,z=-121,dx=10,dy=4,dz=8] unless entity @s[x=411,y=133,z=-3,dx=101,dy=37,dz=142] unless data entity @s Item.tag run kill
execute as @a[tag=!mg0,tag=!mg0+1,tag=!mg0-1,tag=!mg0-2,tag=!mg0-3,nbt=!{Dimension:"minecraft:void"},nbt=!{Dimension:"minecraft:parallel_overworld"},nbt=!{Dimension:"minecraft:parallel_nether"},nbt=!{Dimension:"minecraft:the_end"}] at @s anchored eyes unless score @s mgc matches -1.. run execute as @e[type=item,tag=,nbt={Age:0s},distance=..150000] at @s unless score @p drop matches 1.. unless entity @s[x=-254,y=17,z=-123,distance=..13] unless entity @s[x=-295,y=13,z=54,dx=6,dy=3] unless entity @s[x=-187,y=2,z=-153,distance=..9] unless entity @s[x=-203,y=2,z=-149,distance=..9] unless entity @s[x=-192,y=2,z=-121,dx=10,dy=4,dz=8] unless entity @s[x=411,y=133,z=-3,dx=101,dy=37,dz=142] unless data entity @s Item.tag run kill
execute as @a[tag=!mg0,tag=!mg0+1,tag=!mg0-1,tag=!mg0-2,tag=!mg0-3,nbt=!{Dimension:"minecraft:void"},nbt=!{Dimension:"minecraft:parallel_overworld"},nbt=!{Dimension:"minecraft:parallel_nether"},nbt=!{Dimension:"minecraft:the_end"}] at @s anchored eyes unless score @s mgc matches -1.. run execute as @e[type=item,tag=,nbt={Age:0s},distance=..150000] at @s unless score @p drop matches 1.. unless entity @s[x=-254,y=17,z=-123,distance=..13] unless entity @s[x=-295,y=13,z=54,dx=6,dy=3] unless entity @s[x=-187,y=2,z=-153,distance=..9] unless entity @s[x=-203,y=2,z=-149,distance=..9] unless entity @s[x=-192,y=2,z=-121,dx=10,dy=4,dz=8] unless entity @s[x=411,y=133,z=-3,dx=101,dy=37,dz=142] unless data entity @s Item.tag run kill
execute as @a[tag=!mg0,scores={mgc=-1..}] at @s anchored eyes unless score @s drop matches 1.. run execute as @e[type=item,tag=mgc_m0b,nbt={Age:0s}] at @s unless score @p drop matches 1.. run kill
execute as @a[tag=!mg0,scores={mgc=-1..}] at @s anchored eyes unless score @s drop matches 1.. run execute as @e[type=item,tag=mgc_m0b,nbt={Age:0s}] at @s unless score @p drop matches 1.. run kill
execute as @a[tag=!mg0,scores={mgc=-1..}] at @s anchored eyes unless score @s drop matches 1.. run execute as @e[type=item,tag=mgc_m0b,nbt={Age:0s}] at @s unless score @p drop matches 1.. run kill
