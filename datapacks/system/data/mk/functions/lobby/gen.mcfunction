...
#C
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:2}}]}] run data merge block -42 3 -18 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c1:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"yellow","text":"SURVIVAL"}',Text1:'{"color":"green","text":"@----------@"}'}
...
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:2}}]}] run data merge block -33 3 -8 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c2:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"yellow","text":"STRATEGY"}',Text1:'{"color":"green","text":"@----------@"}'}
...
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:2}}]}] run data merge block -42 3 2 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c3:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"yellow","text":"PARKOUR"}',Text1:'{"color":"green","text":"@----------@"}'}
...
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:2}}]}] run data merge block -51 3 -8 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c4:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"yellow","text":"LOGIC"}',Text1:'{"color":"green","text":"@----------@"}'}
...
#B
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:1}}]}] run data merge block -42 3 -18 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c1:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"aqua","text":"PVE"}',Text1:'{"color":"green","text":"@----------@"}'}
...
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:1}}]}] run data merge block -33 3 -8 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c2:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"aqua","text":"PVP"}',Text1:'{"color":"green","text":"@----------@"}'}
...
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:1}}]}] run data merge block -42 3 2 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c3:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"aqua","text":"EVE"}',Text1:'{"color":"green","text":"@----------@"}'}
...
#P
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:4}}]}] run data merge block -42 3 -18 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c1:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"light_purple","text":"SKILL"}',Text1:'{"color":"green","text":"@----------@"}'}
...
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:4}}]}] run data merge block -33 3 -8 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c2:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"light_purple","text":"RACE"}',Text1:'{"color":"green","text":"@----------@"}'}
...
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:4}}]}] run data merge block -42 3 2 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c3:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"light_purple","text":"MISCELLANEOUS"}',Text1:'{"color":"green","text":"@----------@"}'}
...
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:3}}]}] run data merge block -33 3 -8 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c2:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"green","text":"DUNGEON"}',Text1:'{"color":"green","text":"@----------@"}'}
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:3}}]}] run data merge entity @e[limit=1,x=-33,y=4,z=-8,dy=1] {Item:{id:skeleton_skull,Count:1}}
...
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:3}}]}] run data merge block -51 3 -8 {Text3:'{"color":"green","clickEvent":{"action":"run_command","value":"function c4:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"green","text":"ESCAPE"}',Text1:'{"color":"green","text":"@----------@"}'}
execute if entity @s[tag=C_] if entity @e[tag=c0,nbt={ArmorItems:[{tag:{cg:3}}]}] run data merge entity @e[limit=1,x=-51,y=4,z=-8,dy=1] {Item:{id:golden_chestplate,Count:1}}
...
#C
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:2}}]}] run data merge block -123 3 -79 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d1:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"yellow","text":"LOGIC"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:2}}]}] run data merge block -113 3 -88 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d2:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"yellow","text":"STRATEGY"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:2}}]}] run data merge block -103 3 -79 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d3:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"yellow","text":"SURVIVAL"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:2}}]}] run data merge block -113 3 -70 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d4:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"yellow","text":"COMMUNITY"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
#B
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:1}}]}] run data merge block -123 3 -79 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d1:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"aqua","text":"PVE"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:1}}]}] run data merge block -113 3 -88 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d2:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"aqua","text":"PVP"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:1}}]}] run data merge block -103 3 -79 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d3:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"aqua","text":"BVB"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
#P
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:4}}]}] run data merge block -123 3 -79 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d1:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"light_purple","text":"SKILL"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:4}}]}] run data merge block -113 3 -88 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d2:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"light_purple","text":"RACE"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:4}}]}] run data merge block -103 3 -79 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d3:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"light_purple","text":"CREATIVE"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
...
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:3}}]}] run data merge block -113 3 -88 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d2:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"green","text":"COMING SOON!"}',Text1:'{"color":"light_purple","text":"@----------@"}'}
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:3}}]}] run data merge entity @e[limit=1,x=-113,y=4,z=-88,dy=1] {Item:{id:writable_book,Count:1}}
...
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:3}}]}] run data merge block -113 3 -70 {Text3:'{"color":"light_purple","clickEvent":{"action":"run_command","value":"function d4:join"},"text":"@----------@"}',Text2:'{"bold":true,"color":"green","text":""}',Text1:'{"color":"light_purple","text":"@----------@"}'}
execute if entity @s[tag=D_] if entity @e[tag=d0,nbt={ArmorItems:[{tag:{cg:3}}]}] run data merge entity @e[limit=1,x=-113,y=4,z=-70,dy=1] {Item:{id:dark_oak_sign,Count:1}}
