...
execute if entity @a[scores={mg15=1..}] run tellraw @s ["",{"text":"[","color":"aqua","bold":true},{"text":"@","color":"gold","obfuscated":true},{"text":"]","color":"aqua","bold":true},{"text":" Preset failed to substitute existing ","color":"red"},{"text":"Skyblock","color":"yellow"},{"text":" island (active game)","color":"red"}]
...
execute unless entity @a[scores={mg15=1..}] in void run forceload add 0 0
execute unless entity @a[scores={mg15=1..}] in void run setblock 0 108 0 structure_block[mode=load]{metadata:"",mirror:"NONE",ignoreEntities:1b,powered:0b,seed:0L,posX:0,mode:"LOAD",posY:1,sizeX:15,posZ:0,integrity:1.0f,showair:0b,name:"mk:skyblock",sizeY:21,sizeZ:15,showboundingbox:0b}
execute unless entity @a[scores={mg15=1..}] in void run setblock 0 107 0 redstone_block
execute unless entity @a[scores={mg15=1..}] in void run fill 0 107 0 0 108 0 air
execute unless entity @a[scores={mg15=1..}] in void run forceload remove 0 0
