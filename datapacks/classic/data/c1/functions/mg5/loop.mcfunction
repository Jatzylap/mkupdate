...
execute as @a[tag=SPmg5,x=-5,y=6,z=35,distance=9..] at @s run tp -77 8 85
execute as @a[tag=SPmg5,x=-5,y=6,z=35,distance=9..] at @s run gamemode adventure
execute as @a[tag=SPmg5,x=-5,y=6,z=35,distance=9..] at @s run scoreboard players reset @s mg5
execute as @a[tag=SPmg5,x=-5,y=6,z=35,distance=9..] at @s run tag @s remove SPmg5

execute as @r[scores={mg5=0..},tag=!st0red] at @s run function mk:store
tag @e[tag=st0rage,x=-21,y=1,z=18,dx=34,dy=16,dz=33] add mg5
tp @e[tag=st0rage,tag=mg5] -5 2 35
execute as @a[scores={mg5=0..,lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[scores={mg5=0..,lobby=1..},tag=st0red] at @s run tp @e[sort=random,limit=1,tag=st0rage,tag=mg5] @s
execute as @a[scores={mg5=0..,lobby=1..},tag=st0red] at @s run scoreboard players reset @s mg5
...
execute as @a[scores={mg5.2=9..}] at @s if score @e[name="M@K",limit=1] mg5.2 matches 92 run title @a[scores={mg5=1..},tag=SDplayers] actionbar ["",{"text":"You may Punch now!","color":"aqua","bold":true}]
