...
execute unless entity @e[tag=st0rage,tag=mg5] run tag @a[scores={mg5=0..}] remove st0red
tp @s[scores={mg5=0..}] -67 3 76
tp @s[tag=SPmg5] -5 8 35
particle cloud -67 4 76 1 1 1 0.1 3000 force @a[tag=P0ft,tag=!N0,scores={mg5=0..}]
