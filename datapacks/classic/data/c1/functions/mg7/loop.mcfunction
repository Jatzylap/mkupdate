...
execute as @a[tag=SPmg7] at @s unless entity @s[x=101,y=2,z=-31,dx=29,dz=28,dy=20] run tp 115 23 -17

execute as @a[scores={mg7=1..},tag=!st0red] at @s run function mk:store
execute as @a[scores={mg7=0..,lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[scores={mg7=0..,2=1..},tag=st0red] at @s run function mk:exit
execute as @a[scores={mg7=0..,lobby=1..}] at @s run tag @s remove TRLonely
execute as @a[scores={mg7=0..,lobby=1..}] at @s run tag @s remove TRplayers
execute as @a[scores={mg7=0..,lobby=1..}] at @s run tag @s remove SPmg7
execute as @a[scores={mg7=0..,lobby=1..}] at @s run scoreboard players reset @s mg7
...
execute as @a[scores={mg7=1..,mg7.3=..0},tag=TRplayers] at @s in overworld run fill ~-1 ~ ~-1 ~1 ~-3 ~1 air replace tnt
execute as @a[scores={mg7=1..,mg7.3=..0},tag=TRplayers] at @s in overworld run fill ~ ~ ~ ~ ~-3 ~ air replace sandstone
...
execute as @a[limit=1,tag=TRplayers,scores={mg7=1..,mg7.1=1..}] at @s run fill ~-1 0 ~-1 ~1 0 ~1 sandstone keep