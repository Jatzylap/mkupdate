...
tp @s[scores={mg4=1..}] 80 7 -16
tp @s[tag=SPmg4] 80 7 4
particle cloud 80 8 -16 1 1 1 0.1 3000 force @a[tag=P0ft,tag=!N0,scores={mg4=1..}]
title @s[tag=!T0] clear
title @s[tag=!T0] reset
title @s[tag=PG] title ["",{"text":"Fireball","color":"yellow","bold":true},{"text":" Dodge","color":"red","bold":true}]
