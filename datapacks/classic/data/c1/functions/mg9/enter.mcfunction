...
execute unless entity @e[tag=st0rage,tag=mg9] run tag @a[scores={mg9=1..}] remove st0red
tp @s[scores={mg9=0..}] -67 3 76
tp @s[tag=SPmg9] 109.0 38 -58.0
particle cloud -67 4 76 1 1 1 0.1 3000 force @a[tag=P0ft,tag=!N0,scores={mg9=0..}]
