...
execute as @a[tag=SPmg9] at @s unless entity @s[x=95,y=19,z=-69,dx=27,dz=28,dy=21] run tp -77 8 85
execute as @a[tag=SPmg9] at @s unless entity @s[x=95,y=19,z=-69,dx=27,dz=28,dy=21] run gamemode adventure
execute as @a[tag=SPmg9] at @s unless entity @s[x=95,y=19,z=-69,dx=27,dz=28,dy=21] run scoreboard players reset @s mg9
execute as @a[tag=SPmg9] at @s unless entity @s[x=95,y=19,z=-69,dx=27,dz=28,dy=21] run tag @s remove SPmg9

execute as @r[scores={mg9=0..},tag=!st0red] at @s run function mk:store
tag @e[tag=st0rage,x=95,y=19,z=-69,dx=27,dz=28,dy=21] add mg9
tp @e[tag=st0rage,tag=mg9] 109.0 36 -58.0
execute as @a[scores={mg9=0..,lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[scores={mg9=0..,lobby=1..},tag=st0red] at @s run scoreboard players reset @s mg9
