...
execute as @a[tag=SPmg6,x=100,y=46,z=-17,distance=16..] at @s run tp -77 8 85
execute as @a[tag=SPmg6,x=100,y=46,z=-17,distance=16..] at @s run gamemode adventure
execute as @a[tag=SPmg6,x=100,y=46,z=-17,distance=16..] at @s run scoreboard players reset @s mg6
execute as @a[tag=SPmg6,x=100,y=46,z=-17,distance=16..] at @s run tag @s remove SPmg6

execute as @r[scores={mg6=0..},tag=!st0red] at @s run function mk:store
tag @e[tag=st0rage,x=100,y=46,z=-17,distance=..18] add mg6
tp @e[tag=st0rage,tag=mg6] 100 46 -17
execute as @a[scores={mg6=0..,lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[scores={mg6=0..,lobby=1..},tag=st0red] at @s run tp @e[sort=random,limit=1,tag=st0rage,tag=mg6] @s
execute as @a[scores={mg6=0..,2=1..},tag=st0red] at @s run clear @s #vf_items{CPG:1b}
execute as @a[scores={mg6=0..,lobby=1..},tag=st0red] at @s run scoreboard players reset @s mg6
...
execute unless entity @a[scores={mg6=0}] run tag @e[x=100,y=46,z=-17,distance=..18,type=item,nbt={Item:{id:"minecraft:terracotta"}}] add mg6
