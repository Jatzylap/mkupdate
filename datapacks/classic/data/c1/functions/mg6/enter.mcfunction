...
execute unless entity @e[tag=st0rage,tag=mg6] run tag @a[scores={mg6=1..}] remove st0red
tp @s[scores={mg6=0..}] -67 3 76
tp @s[tag=SPmg6] 100 50 -17
particle cloud -67 4 76 1 1 1 0.1 3000 force @a[tag=P0ft,tag=!N0,scores={mg6=0..}]
