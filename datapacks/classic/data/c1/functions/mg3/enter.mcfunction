...
team leave @s[tag=!T0]
execute at @s[tag=PG] if data block -78 9 81 {Text3:'{"obfuscated":true,"color":"gold","clickEvent":{"action":"run_command","value":"tag @s[tag=!T0] add SPmg3"},"text":"@"}'} run tag @s add SPmg3
scoreboard players add @s[tag=!T0] mg3 1
tp @s[scores={mg3=1..}] -67 3 76
tp @s[tag=SPmg3] -32 27 108
particle cloud -67 4 76 1 1 1 0.1 3000 force @s[tag=P0ft,tag=!N0,scores={mg3=1..}]
title @s[tag=!T0] clear
title @s[tag=!T0] reset
title @s[tag=PG] title ["",{"text":"Spleef","bold":true}]
title @s[tag=PG,tag=SPmg3] title ["",{"text":"Spectating","color":"gray","bold":true}]
