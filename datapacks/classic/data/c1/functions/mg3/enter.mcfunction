...
execute unless entity @e[tag=st0rage,tag=mg3] run tag @a[scores={mg3=1..}] remove st0red
tp @s[scores={mg3=1..}] -67 3 76
tp @s[tag=SPmg3] -32 27 108
particle cloud -67 4 76 1 1 1 0.1 3000 force @a[tag=P0ft,tag=!N0,scores={mg3=1..}]
