...
execute as @a[tag=SPmg3,x=-32,y=26,z=108,distance=16..] at @s run tp -77 8 85
execute as @a[tag=SPmg3,x=-32,y=26,z=108,distance=16..] at @s run gamemode adventure
execute as @a[tag=SPmg3,x=-32,y=26,z=108,distance=16..] at @s run scoreboard players reset @s mg3
execute as @a[tag=SPmg3,x=-32,y=26,z=108,distance=16..] at @s run tag @s remove SPmg3

execute as @r[scores={mg3=1..},tag=!st0red] at @s run function mk:store
tag @e[tag=st0rage,x=-50,y=1,z=90,dx=36,dy=30,dz=36] add mg3
tp @e[tag=st0rage,tag=mg3] -32 26 108
execute as @a[scores={mg3=1..,lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[scores={mg3=1..,lobby=1..},tag=st0red] at @s run tp @e[sort=random,limit=1,tag=st0rage,tag=mg3] @s
execute as @a[scores={mg3=1..,2=1..},tag=st0red] at @s run clear @s #spleef_items{CPG:1b}
execute as @a[scores={mg3=1..,lobby=1..},tag=st0red] at @s run scoreboard players reset @s mg3

#Main
execute as @a[scores={mg3=1..,mg3.1=0},tag=SpleefPlayers] at @s if block ~ ~-1 ~ lava run function c1:mg3/death
