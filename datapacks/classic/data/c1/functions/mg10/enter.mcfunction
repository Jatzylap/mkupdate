...
execute unless entity @e[tag=st0rage,tag=mg10] run tag @a[scores={mg10=1..}] remove st0red
tp @s[scores={mg10=1..}] -67 3 76
tp @s[tag=SPmg10] -2.0 9 133.0
particle cloud -67 4 76 1 1 1 0.1 3000 force @a[tag=P0ft,tag=!N0,scores={mg10=1..}]
