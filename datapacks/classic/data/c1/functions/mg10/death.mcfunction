...
tellraw @a[scores={mg10=1..},tag=CMplayers] ["",{"text":""},{"selector":"@a[scores={mg10.2=1..,mg10.1=0},tag=CMplayers]","color":"green"},{"text":" couldn\'t match his favourite colour!","color":"yellow"}]
