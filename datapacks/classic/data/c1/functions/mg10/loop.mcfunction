...
execute as @a[tag=SPmg10] at @s unless entity @s[x=-13,y=2,z=122,dx=20,dz=20,dy=8] run tp -2.0 9 133.0
...
execute as @a[scores={mg10=1..,2=1..},tag=st0red] at @s run function mk:exit
execute as @a[scores={mg10=1..,lobby=1..}] at @s run tag @s remove SPmg10
execute as @a[scores={mg10=1..,lobby=1..}] at @s run scoreboard players reset @s mg10
