...
tag @e[type=!player,type=!villager,type=!item,x=367,y=0,z=-173,dx=73,dy=99,dz=70] add mg8
execute as @a[team=mg8,scores={lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[team=mg8,scores={2=1..},tag=st0red] at @s run function mk:exit
execute as @a[team=mg8,scores={2=1..},tag=st0red] at @s run team leave
execute as @a[team=mg8,scores={lobby=1..}] at @s run tag @s remove SPmg8
execute as @a[team=mg8,scores={lobby=1..}] at @s run team leave
