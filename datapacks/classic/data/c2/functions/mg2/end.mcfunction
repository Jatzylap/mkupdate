...
execute if score @e[name="M@K",limit=1] mg2 matches 0 run tellraw @a[scores={mg2=1..},team=!] ["",{"text":"Bed","color":"aqua","bold":true},{"text":"Wars","color":"red","bold":true},{"text":"> "},{"text":"Game end reached! Dragons have now been released!","color":"yellow","bold":true}]
execute if score @e[name="M@K",limit=1] mg2 matches 1 run tellraw @a[scores={mg2=1..},team=!] ["",{"text":"Egg","color":"aqua","bold":true},{"text":"Wars","color":"red","bold":true},{"text":"> "},{"text":"Game end reached! Dragons have now been released!","color":"yellow","bold":true}]
execute if score @e[name="M@K",limit=1] mg2 matches 0 run setblock 440 159 135 air destroy
execute if score @e[name="M@K",limit=1] mg2 matches 0 run setblock 508 159 69 air destroy
