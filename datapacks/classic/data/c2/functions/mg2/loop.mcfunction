...
tag @e[type=!player,type=!item_frame,nbt=!{Item:{id:"minecraft:oak_sign"}},nbt=!{Item:{id:"minecraft:red_bed"}},nbt=!{Item:{id:"minecraft:yellow_bed"}},nbt=!{Item:{id:"minecraft:blue_bed"}},x=411,y=133,z=-3,dx=101,dy=37,dz=142] add mg2
tag @e[type=item,x=411,y=133,z=-3,dx=101,dy=37,dz=142] add mg2_item
tag @e[type=item,nbt=!{Item:{id:"minecraft:cake"}},nbt=!{Item:{id:"minecraft:chest"}},nbt=!{Item:{id:"minecraft:end_stone"}},nbt=!{Item:{id:"minecraft:obsidian"}},nbt=!{Item:{id:"minecraft:red_concrete"}},nbt=!{Item:{id:"minecraft:yellow_concrete"}},nbt=!{Item:{id:"minecraft:blue_concrete"}}] remove mg2_item
execute as @e[type=item,tag=mg2_item] at @s run data merge entity @s {Item:{tag:{HideFlags:31,CanDestroy:["chest","cake","red_concrete","yellow_concrete","blue_concrete","end_stone","obsidian"],CanPlaceOn:["chest","cake","red_concrete","yellow_concrete","blue_concrete","stone_bricks","grass_block","#wool","end_stone","obsidian","sandstone"]}}}
execute as @a[scores={mg2=1..,lobby=1..}] at @s run tag @s remove STGplayers
execute as @a[scores={mg2=1..,lobby=1..}] at @s run tag @s remove SPmg2
execute as @a[scores={mg2=1..,lobby=1..}] at @s run clear @s
execute as @a[scores={mg2=1..,lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[scores={mg2=1..,2=1..},tag=st0red] at @s run function mk:exit
execute as @a[scores={mg2=1..,2=1..},tag=st0red] at @s run scoreboard players reset @s mg2

#Main
kill @e[type=falling_block,tag=mg2]
kill @e[type=item,tag=!mg2,x=411,y=133,z=-3,dx=101,dy=37,dz=142]
...
execute if entity @a[scores={mg2=1..},team=!,tag=STGplayers] run schedule function c2:mg2/test 3s replace
...
scoreboard players reset @a[scores={mg2=1..}] mg2.4
...
#Award
execute as @a[scores={mg2=1..},tag=STGplayers,team=mg2-blue] at @s unless entity @a[scores={mg2=1..},tag=STGplayers,team=!,team=!mg2-blue] run bossbar set sg_countdown color blue
execute as @a[scores={mg2=1..},tag=STGplayers,team=mg2-blue] at @s unless entity @a[scores={mg2=1..},tag=STGplayers,team=!,team=!mg2-blue] run tag @s add mg2_win
execute as @a[scores={mg2=1..},tag=STGplayers,team=mg2-yellow] at @s unless entity @a[scores={mg2=1..},tag=STGplayers,team=!,team=!mg2-yellow] run bossbar set sg_countdown color yellow
execute as @a[scores={mg2=1..},tag=STGplayers,team=mg2-yellow] at @s unless entity @a[scores={mg2=1..},tag=STGplayers,team=!,team=!mg2-yellow] run tag @s add mg2_win
execute as @a[scores={mg2=1..},tag=STGplayers,team=mg2-red] at @s unless entity @a[scores={mg2=1..},tag=STGplayers,team=!,team=!mg2-red] run bossbar set sg_countdown color red
execute as @a[scores={mg2=1..},tag=STGplayers,team=mg2-red] at @s unless entity @a[scores={mg2=1..},tag=STGplayers,team=!,team=!mg2-red] run tag @s add mg2_win
execute as @a[scores={mg2=1..},tag=mg2_win] at @s run setblock -345 2 -78 redstone_block keep

#Generator
execute as @e[tag=r0t,tag=i,tag=mg2,scores={mg2.2=0}] at @s run summon item ~ ~ ~ {Item:{Count:1,id:iron_ingot,tag:{mg:2}}}
execute as @e[tag=r0t,tag=g,tag=mg2,scores={mg2.2=0}] at @s run summon item ~ ~ ~ {Item:{Count:1,id:gold_ingot,tag:{mg:2}}}
execute as @e[tag=r0t,tag=d,tag=mg2,scores={mg2.2=0}] at @s run summon item ~ ~ ~ {Item:{Count:1,id:diamond,tag:{mg:2}}}
execute as @e[tag=r0t,tag=e,tag=mg2,scores={mg2.2=0}] at @s run summon item ~ ~ ~ {Item:{Count:1,id:emerald,tag:{mg:2}}}
