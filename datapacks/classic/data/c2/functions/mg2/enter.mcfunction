...
execute unless entity @e[tag=st0rage,tag=mg2] run tag @a[scores={mg2=1..}] remove st0red
...
particle cloud 104 5 -63 1 1 1 0.1 3000 force @a[tag=P0ft,tag=!N0,scores={mg2=1..}]
