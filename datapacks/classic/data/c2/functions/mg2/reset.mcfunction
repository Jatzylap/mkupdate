...
kill @e[type=area_effect_cloud,x=411,y=133,z=-3,dx=101,dy=37,dz=142]
...
execute as @a[scores={mg2=1..}] at @s run function mk:restore
tag @a remove SPmg2
...
data merge block -14 5 -12 {Text3:'{"text":""}'}