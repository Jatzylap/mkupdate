...
execute at @s[tag=mg22_s3] run summon armor_stand ~0.27 ~0.59 ~0.16 {Marker:1,NoBasePlate:1,NoGravity:1,ShowArms:1,DisabledSlots:-1,Invisible:1,Invulnerable:1,Pose:{LeftArm:[-90f,33f,0f]},Tags:[mg22,dballista_p2],Rotation:[163f],HandItems:[{},{id:crossbow,Count:1}]}
