...
execute as @e[type=creeper,tag=mg22_mob] at @s if block ~ ~-1 ~ chiseled_stone_bricks run scoreboard players remove @e[tag=mg22_start] mg22.5 3
execute as @e[type=creeper,tag=mg22_mob,nbt={powered:1b}] at @s if block ~ ~-1 ~ chiseled_stone_bricks run scoreboard players remove @e[tag=mg22_start] mg22.5 5
...
execute as @e[type=goat,tag=mg22_mob] at @s if block ~ ~-1 ~ chiseled_stone_bricks run scoreboard players remove @e[tag=mg22_start] mg22.5 9
...
execute as @e[tag=mg22_mob] at @s if block ~ ~-1 ~ chiseled_stone_bricks run scoreboard players add @e[name="M@K",limit=1] mg22.1 5
...
#Surrender
execute as @e[tag=mg22_mob] at @s unless entity @s[x=193,y=0,z=-221,dx=74,dy=3,dz=83] run data merge entity @s {Health:0,DeathTime:19s,DeathLootTable:""}
...
execute as @e[tag=mg22_rider] at @s if data entity @s Passengers run tp @s @e[limit=1,sort=nearest,distance=..1.8,tag=mg22_carrier]

#speed
execute if score @e[tag=mg22_start,limit=1] mg22.2 matches 0.. as @e[nbt={ActiveEffects:[{Id:2b,Amplifier:4b}]},type=!goat,tag=mg22_mob,type=!hoglin] at @s run tp ^ ^ ^0.06
execute if score @e[tag=mg22_start,limit=1] mg22.2 matches 0.. as @e[nbt={ActiveEffects:[{Id:2b,Amplifier:4b}]},tag=mg22_mob,type=hoglin] at @s run tp ^ ^ ^0.02
execute if score @e[tag=mg22_start,limit=1] mg22.2 matches 0.. as @e[nbt=!{ActiveEffects:[{Id:2b}]},type=!goat,tag=mg22_mob,type=!hoglin] at @s run tp ^ ^ ^0.15
execute if score @e[tag=mg22_start,limit=1] mg22.2 matches 0.. as @e[nbt=!{ActiveEffects:[{Id:2b}]},tag=mg22_mob,type=hoglin] at @s run tp ^ ^ ^0.08
execute if score @e[tag=mg22_start,limit=1] mg22.2 matches 10.. as @e[nbt=!{ActiveEffects:[{Id:2b}]},type=!goat,tag=mg22_mob] at @s run tp ^ ^ ^0.04
