...
execute in sister_dimension run fill 161 -11 -192 122 -20 -168 green_wool replace #wool
execute in sister_dimension run fill 122 -8 -192 161 -8 -168 green_wool
...
execute in sister_dimension run kill @e[tag=mg22_lvl]
execute in sister_dimension run kill @e[tag=mg22_m]
execute in sister_dimension run kill @e[tag=mg22_path]
execute in sister_dimension run forceload add 161 -168 122 -192
execute in sister_dimension run forceload add 193 -210 264 -138
