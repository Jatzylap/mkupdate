#Structure 1
execute at @s[tag=catapult_p1] run tp @s ~ ~ ~ facing entity @e[tag=mg22_mob,sort=nearest,limit=1]
...
#Structures 2-3
execute at @s[tag=ballista_p1] run tp @s ~ ~ ~ facing entity @e[tag=mg22_mob,sort=nearest,limit=1]
execute at @s[tag=ballista_p2] run tp @s ~ ~ ~ facing entity @e[tag=mg22_mob,sort=nearest,limit=1]
execute at @s[tag=dballista_p1] run tp @s ~ ~ ~ facing entity @e[tag=mg22_mob,sort=nearest,limit=1]
execute at @s[tag=dballista_p2] run tp @s ~ ~ ~ facing entity @e[tag=mg22_mob,sort=nearest,limit=1]
execute at @s[tag=dballista_p3] run tp @s ~ ~ ~ facing entity @e[tag=mg22_mob,sort=nearest,limit=1]
...
execute at @s[tag=medusa_eye] run tp @s ~ ~ ~ facing entity @e[tag=mg22_mob,sort=nearest,limit=1]
execute at @s[tag=medusa_eye] unless entity @e[tag=mg22_start] run tp @s ~ ~ ~ facing entity @p

#Structures 11-15
execute at @s[tag=snow_golem] run tp @s ~ ~ ~ facing entity @e[tag=mg22_mob,sort=nearest,limit=1]
