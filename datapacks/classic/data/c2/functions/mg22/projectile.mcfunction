...
execute at @s[tag=s3] run summon arrow ^-0.2 ^2 ^1.5 {Tags:[mg22_b,mg22]}
...
execute at @s[tag=s3] run summon arrow ^0.2 ^2 ^1.5 {Tags:[mg22_b,mg22_b2,mg22]}
execute at @s[tag=s3] store result entity @e[tag=mg22_b2,sort=nearest,limit=1] Motion[0] double 0.003 run scoreboard players get @s mg-1.x
execute at @s[tag=s3] store result entity @e[tag=mg22_b2,sort=nearest,limit=1] Motion[2] double 0.003 run scoreboard players get @s mg-1.z
