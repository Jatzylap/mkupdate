...
#PVP
execute if entity @s[x=-18,y=4,z=-13,distance=..5,tag=!PG] run loot replace block -18 5 -8 container.0 loot c2:random/pvp
execute if entity @s[x=-18,y=4,z=-13,distance=..5,tag=PG_] run loot replace block -18 5 -8 container.0 loot c2:random/pvp
...
execute if entity @s[x=-18,y=4,z=-13,distance=..5] if data block -18 5 -8 Items[{tag:{mg:23}}] run function c2:mg23/enter