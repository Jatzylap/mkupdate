...
execute as @a[tag=CTM3achieve] at @s store success score @s 3 run advancement grant @s only mk:unlock_all mg14
scoreboard players add @a[tag=CTM3achieve,scores={3=1}] 7 1
