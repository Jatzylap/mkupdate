...
execute as @a[tag=CTM2achieve] at @s store success score @s 3 run advancement grant @s only mk:unlock_all mg21
scoreboard players add @a[tag=CTM2achieve,scores={3=1}] 7 1
...
execute in parallel_aether at @s[tag=!T0] unless entity @e[tag=CTM2_Mob2] run function c4:mg21/initiate
