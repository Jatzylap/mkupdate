...
execute in parallel_aether if score @s[tag=mg21_soul1] mg21 matches 16 run summon wither_skeleton 177.2 134 178.0 {PersistenceRequired:1,Invulnerable:1,Rotation:[90f],Silent:1,Tags:[mg21,CTM2_Mob2,guard1],Attributes:[{Name:generic.knockback_resistance,Base:1d},{Name:generic.follow_range,Base:99.0d}],Silent:1,DeathLootTable:"",HandItems:[{Count:1,id:netherite_sword}],ArmorItems:[{},{},{},{Count:1,id:observer}]}
execute in parallel_aether if score @s[tag=mg21_soul2] mg21 matches 16 run summon wither_skeleton 234.2 106 216.0 {PersistenceRequired:1,Invulnerable:1,Rotation:[90f],Silent:1,Tags:[mg21,CTM2_Mob2,guard2],Attributes:[{Name:generic.knockback_resistance,Base:1d},{Name:generic.follow_range,Base:99.0d}],Silent:1,DeathLootTable:"",HandItems:[{Count:1,id:netherite_sword}],ArmorItems:[{},{},{},{Count:1,id:observer}]}
execute in parallel_aether if score @s[tag=mg21_soul3] mg21 matches 16 run summon wither_skeleton 148.2 130 224.0 {PersistenceRequired:1,Invulnerable:1,Rotation:[90f],Silent:1,Tags:[mg21,CTM2_Mob2,guard3],Attributes:[{Name:generic.knockback_resistance,Base:1d},{Name:generic.follow_range,Base:99.0d}],Silent:1,DeathLootTable:"",HandItems:[{Count:1,id:netherite_sword}],ArmorItems:[{},{},{},{Count:1,id:observer}]}
