...
execute as @a[scores={mg13=1..},tag=Drop4,tag=Win] at @s store success score @s 3 run advancement grant @s only mk:unlock_all mg13
scoreboard players add @a[scores={mg13=1..,3=1},tag=Drop4,tag=Win] 7 1
