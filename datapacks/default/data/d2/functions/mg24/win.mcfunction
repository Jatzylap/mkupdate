...
execute unless score @e[name="M@K",limit=1] mg24.8 matches 0.. as @a[scores={mg24=1..}] at @s run title @s subtitle ["",{"score":{"name":"#mg24-pink","objective":"mg24.7"},"color":"light_purple","bold":true},{"text":" = ","color":"gold","bold":true},{"score":{"name":"#mg24-green","objective":"mg24.7"},"color":"green","bold":true}]
xp add @a[tag=mg24_win] 100 points
scoreboard players reset * mg24.7
tag @a[tag=MMplayers] remove MMplayers
