...
execute as @a[tag=SPmg16] at @s unless entity @s[x=113,y=3,z=-435,dx=58,dy=45,dz=158] run tp @s -90 3 -97
execute as @a[tag=SPmg16] at @s unless entity @s[x=113,y=3,z=-435,dx=58,dy=45,dz=158] run gamemode adventure @s
execute as @a[tag=SPmg16] at @s unless entity @s[x=113,y=3,z=-435,dx=58,dy=45,dz=158] run tag @s remove SPmg16
...
execute as @a[scores={mg16=1..,lobby=1..},tag=st0red] at @s run tag @s remove GWdead
execute as @a[scores={mg16=1..,lobby=1..},tag=st0red] at @s run tag @s remove GWplayers
execute as @a[scores={mg16=1..,lobby=1..},tag=st0red] at @s run tag @s remove SPmg16
execute as @a[scores={mg16=1..,lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[scores={mg16=1..,2=1..},tag=st0red] at @s run scoreboard players reset @s mg16
...
execute as @e[tag=mg16,tag=rtnt] at @s if block ~ ~-1 ~ barrier run particle cloud ~ ~-10 ~ 1 0 1 0 500 normal @a[scores={mg16=1..}]
...
execute if score @e[limit=1,name="M@K"] mg16.2_3 matches 1 run title @a[scores={mg16=1..},team=mg16-blue,tag=GWplayers] actionbar ["",{"text":"Husks","color":"gold","bold":true},{"text":" are attempting to attack your","color":"yellow","bold":true},{"text":" Base","color":"gold","bold":true},{"text":"!","color":"yellow","bold":true}]
...
execute if score @e[limit=1,name="M@K"] mg16.2_3 matches 116.. if entity @e[type=husk,tag=mg16,distance=..10] run execute as @e[type=end_crystal,tag=mg16_blue,sort=random,limit=1] at @s run tag @s add exp
execute if score @e[limit=1,name="M@K"] mg16.2_3 matches 116.. run title @a[scores={mg16=1..},team=mg16-blue,tag=GWplayers] actionbar ["",{"text":"Husks","color":"gold","bold":true},{"text":" have destroyed a ","color":"yellow","bold":true},{"text":"Castle crystal ","color":"aqua","bold":true},{"text":"in your Base!","color":"yellow","bold":true}]
...
execute if score @e[limit=1,name="M@K"] mg16.2_4 matches 1 run title @a[scores={mg16=1..},team=mg16-red,tag=GWplayers] actionbar ["",{"text":"Husks","color":"gold","bold":true},{"text":" are attempting to attack your","color":"yellow","bold":true},{"text":" Base","color":"gold","bold":true},{"text":"!","color":"yellow","bold":true}]
...
execute if score @e[limit=1,name="M@K"] mg16.2_4 matches 116.. if entity @e[type=husk,tag=mg16,distance=..10] run execute as @e[type=end_crystal,tag=mg16_red,sort=random,limit=1] at @s run tag @s add exp
execute if score @e[limit=1,name="M@K"] mg16.2_4 matches 116.. run title @a[scores={mg16=1..},team=mg16-red,tag=GWplayers] actionbar ["",{"text":"Husks","color":"gold","bold":true},{"text":" have destroyed a ","color":"yellow","bold":true},{"text":"Castle crystal ","color":"aqua","bold":true},{"text":"in your Base!","color":"yellow","bold":true}]
...
#Death
execute as @a[scores={mg16=1..},tag=GWdrop] at @s run clear @s golden_sword{Enchantments:[{id:"minecraft:vanishing_curse",lvl:1s}]}
execute as @a[scores={mg16=1..},tag=GWdrop] at @s run clear @s golden_sword{Enchantments:[{lvl:2s,id:"knockback"},{lvl:1s,id:"mending"},{lvl:1s,id:"vanishing_curse"}]}
execute as @a[scores={mg16=1..},tag=GWdrop] at @s run clear @s zombie_head{Enchantments:[{lvl:3,id:"respiration"},{lvl:1,id:"binding_curse"},{lvl:1,id:"vanishing_curse"}]}
execute as @a[scores={mg16=1..},tag=GWdrop] at @s run clear @s creeper_head{Enchantments:[{lvl:3,id:"respiration"},{lvl:1,id:"binding_curse"},{lvl:1,id:"vanishing_curse"}]}
tag @a remove GWdrop
...
execute if score @e[limit=1,name="M@K"] mg16.3 matches 1200 run tellraw @a[scores={mg16=1..}] ["",{"text":"Gold","color":"gold","bold":true},{"text":"Wars","color":"aqua","bold":true},{"text":"> ","color":"aqua"},{"text":"1","color":"red","bold":true},{"text":" more minute until","color":"yellow"},{"text":" ALL ","color":"red","bold":true},{"text":"Bases are weakened!","color":"yellow"}]
