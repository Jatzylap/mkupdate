...
#Explosion
execute as @s[type=item,nbt={Item:{tag:{LC:1b,display:{Lore:["{\"text\":\"unlucky:explosion\",\"color\":\"dark_gray\"}"]}}}}] at @s run summon creeper ~ ~ ~ {Fuse:0s}
...
kill @e[type=item,nbt={Item:{id:"minecraft:iron_nugget",tag:{LC:1b}}}]
kill @e[type=item,nbt={Item:{id:"minecraft:gold_nugget",tag:{LC:1b}}}]