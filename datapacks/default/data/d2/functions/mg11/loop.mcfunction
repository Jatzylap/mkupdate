...
execute as @a[scores={mg11=1..}] at @s run tag @e[tag=st0rage,distance=..6] add mg11
tp @e[tag=st0rage,tag=mg11] -100 8 -180
execute as @a[scores={mg11=1..,lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[scores={mg11=1..,lobby=1..},tag=st0red] at @s run tp @e[sort=random,limit=1,tag=st0rage,tag=mg11] @s
execute as @a[scores={mg11=1..,lobby=1..},tag=st0red] at @s run scoreboard players reset @s mg11
...
execute as @a[scores={mg11=1..},tag=LCplayers,limit=1,x=-109,y=7,z=-393,dx=18,dy=5,dz=7] at @s unless entity @a[tag=LCwinner] run tag @s add LCwinner
