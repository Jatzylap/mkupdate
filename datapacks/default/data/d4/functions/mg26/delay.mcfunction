...
execute unless score @e[tag=mg26_start,limit=1,scores={mg26=1}] mg26.2 matches 6.. unless entity @e[tag=mg26,tag=chest] in sister_dimension run summon marker 21 6 -377 {Tags:[mg26,chest]}
...
execute unless score @e[tag=mg26_start,limit=1,scores={mg26=3}] mg26.2 matches 6.. unless entity @e[tag=mg26,tag=chest] in sister_dimension run summon marker 21 6 -377 {Tags:[mg26,chest]}
execute if score @e[tag=mg26_start,limit=1,scores={mg26=1}] mg26.2 matches 6.. unless entity @e[tag=mg26,tag=chest] in sister_dimension run summon marker 21 3.875 -377 {Tags:[mg26,chest]}
...
execute if score @e[tag=mg26_start,limit=1,scores={mg26=3}] mg26.2 matches 6.. unless entity @e[tag=mg26,tag=chest] in sister_dimension run summon marker 21 3.875 -377 {Tags:[mg26,chest]}
execute as @e[tag=mg26_start,limit=1,scores={mg26=1}] at @s unless score @s mg26.2 matches 6.. run scoreboard players set @s mg26.1 0
...
execute as @e[tag=mg26_start,limit=1,scores={mg26=3}] at @s unless score @s mg26.2 matches 6.. run scoreboard players set @s mg26.1 0
