...
execute as @a[tag=mg26_win1,tag=mg26_win2,tag=mg26_win3] at @s run title @s actionbar ["",{"text":" You beat a","bold":true},{"text":" Trivia Cube","color":"yellow","bold":true},{"text":" game!","color":"reset","bold":true}]
