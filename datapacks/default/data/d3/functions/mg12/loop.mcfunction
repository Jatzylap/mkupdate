...
execute as @a[scores={mg12=0..,2=1..},tag=st0red] at @s run clear @s
execute as @a[scores={mg12=0..,2=1..}] at @s run tag @s remove SPmg12
execute as @a[scores={mg12=0..,2=1..},tag=st0red] at @s run function mk:exit
execute as @a[scores={mg12=0..,lobby=1..},tag=st0red] at @s run function mk:restore
execute as @a[scores={mg12=0..,lobby=1..}] at @s run tag @s remove SPmg12
execute as @a[scores={mg12=0..,lobby=1..}] at @s run scoreboard players reset @s mg12
...
#Scare Phantoms
execute if block 298 72 -291 campfire[lit=true] unless entity @e[type=cat,tag=mg12.3_1] run summon cat 298 0 -291 {Tags:[pc,mg12.3_1],Team:mg12,NoAI:1,Silent:1,ActiveEffects:[{Id:14,Amplifier:100,Duration:1000000,ShowParticles:0b}],PersistenceRequired:1b,Invulnerable:1b,DeathLootTable:""}
execute if block 354 71 -285 campfire[lit=true] unless entity @e[type=cat,tag=mg12.3_2] run summon cat 354 0 -285 {Tags:[pc,mg12.3_2],Team:mg12,NoAI:1,Silent:1,ActiveEffects:[{Id:14,Amplifier:100,Duration:1000000,ShowParticles:0b}],PersistenceRequired:1b,Invulnerable:1b,DeathLootTable:""}
execute if block 294 71 -348 campfire[lit=true] unless entity @e[type=cat,tag=mg12.3_3] run summon cat 294 0 -348  {Tags:[pc,mg12.3_3],Team:mg12,NoAI:1,Silent:1,ActiveEffects:[{Id:14,Amplifier:100,Duration:1000000,ShowParticles:0b}],PersistenceRequired:1b,Invulnerable:1b,DeathLootTable:""}
execute as @e[type=cat,tag=mg12.3_1] at @s run tp ~ 72 ~
execute as @e[type=cat,tag=pc,tag=!mg12.3_1] at @s run tp ~ 71 ~
execute as @e[type=cat,tag=pc] at @s if block ~ ~ ~ campfire[lit=false] run data merge entity @s {DeathTime:19s,Health:0}
